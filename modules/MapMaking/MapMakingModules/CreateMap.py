...
class CreateMap:
    ...
    def __init__(
        ...
        pointing_params_path: str = None,
        n_destriper_iterations: int = 1,
        prior_mixing_alpha: float = 0.0,
        ...
        **kwargs,
        ...
        self.base_parameters = {
            ...
            "pointing_params_path": pointing_params_path,
            "n_destriper_iterations": n_destriper_iterations,
            "prior_mixing_alpha": prior_mixing_alpha if use_planck_prior else 0.0,
